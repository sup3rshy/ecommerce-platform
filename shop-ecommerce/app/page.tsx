...
export default async function Home({ searchParams }: PageProps) {
  ...
  // Read-copy: chỉ hiển thị sản phẩm active (ẩn hidden/deleted do ShopSell điều khiển).
      ...
      {isAuthenticated ? (
        <section className="rounded-2xl border border-blue-100 bg-blue-50/40 p-5 shadow-sm">
          ...
          <div className="mt-4 flex flex-wrap gap-3">
            ...
            {roles.includes("buyer") && !roles.includes("food-seller") && (
              <Link
                href="/food-seller/register"
