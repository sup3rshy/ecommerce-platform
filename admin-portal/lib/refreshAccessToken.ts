 ...
 * token expired / revoked / user bị vô hiệu hoá / xoá khỏi AD), set
 * `token.error = "RefreshAccessTokenError"` để client-side biết và force re-login.
 * Đây cũng là nền cho deprovisioning: token TTL ngắn + refresh kiểm tra lại Keycloak.
 */
