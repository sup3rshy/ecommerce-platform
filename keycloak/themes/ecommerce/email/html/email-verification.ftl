          ...
          <table role="presentation" width="100%" cellspacing="0" cellpadding="0" style="max-width:560px;background:#ffffff;border:1px solid #dbe4f0;border-radius:12px;overflow:hidden;">
            <tr>
              <td style="background:#0f172a;color:#ffffff;padding:22px 28px;">
                <div style="font-size:14px;letter-spacing:.08em;text-transform:uppercase;color:#bae6fd;">Ecommerce Platform</div>
                <h1 style="margin:8px 0 0;font-size:24px;line-height:1.25;">Xác thực email của bạn</h1>
              </td>
            </tr>
            <tr>
              <td style="padding:28px;">
                ...
                <p style="margin:0 0 18px;font-size:16px;line-height:1.6;">
                  Bạn vừa đăng ký tài khoản trên <strong>${realmName}</strong>. Vui lòng xác thực email này để hoàn tất đăng ký và bắt đầu sử dụng hệ sinh thái mua sắm.
                </p>
                <p style="margin:28px 0;text-align:center;">
                  <a href="${link}" style="display:inline-block;background:#2563eb;color:#ffffff;text-decoration:none;font-weight:700;font-size:16px;padding:13px 22px;border-radius:8px;">Xác thực email</a>
                </p>
                ...
                <p style="margin:0 0 20px;font-size:13px;line-height:1.5;word-break:break-all;color:#2563eb;">${link}</p>
                <p style="margin:0;font-size:14px;line-height:1.6;color:#64748b;">
                  Nếu bạn không tạo tài khoản này, bạn có thể bỏ qua email. Tài khoản sẽ không được kích hoạt cho tới khi email được xác thực.
                </p>
              </td>
            </tr>
            <tr>
